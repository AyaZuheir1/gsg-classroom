...
Route::get('topic/view', [TopicsController::class, 'index'])->name('topic.index');
// Route::get('topic/show',[TopicsController::class ,'show'])->name('topic.show');

Route::get('topic/create', [TopicsController::class, 'create'])->name('topic.create');
Route::post('topic/add', [TopicsController::class, 'add'])->name('topic.add');

Route::get('topic/edit/{id}', [TopicsController::class, 'edit'])->name('topic.edit');
Route::put('topic/update/{id}', [TopicsController::class, 'update'])->name('topic.update');

Route::delete('/topic/delete/{id}', [TopicsController::class, 'delete'])->name('topic.delete');
